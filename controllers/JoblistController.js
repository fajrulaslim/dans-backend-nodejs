...
const getAllJoblist = async (req, res) => {
  ...
  try {
    const urlDataAll =  `http://dev3.dansmultipro.co.id/api/recruitment/positions.json?description=${description}&location=${location}&type=${type}`
    const urlData = `http://dev3.dansmultipro.co.id/api/recruitment/positions.json?page=${page}&description=${description}&location=${location}&type=${type}`
